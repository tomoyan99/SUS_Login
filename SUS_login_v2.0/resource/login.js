...
const os = require('os');
const ecp = require('./existChromePath.js');
const existChromePath = require('./existChromePath.js');
const input = require('./input.js');
const choice = require("./sentaku");
...
(async function main() {
	...
	*/
	...
	const choose = await(async () => {
		...
		return state.option[state.index];
	})();

	let whichOpen = {
		"1.sclass":["sclass"],
		"2.sola":["sola"],
		"3.sclassとsola":["sclass","sola"],
		"4.euc":["euc"]
	};
